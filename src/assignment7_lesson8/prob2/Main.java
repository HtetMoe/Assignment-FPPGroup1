...
public class Main {
	/*
		API Array List
		- compute sum of salary in Statistics, by calling getSalary()
		- combine 2 list of Staff and Teacher
		- passed combined list into computeSumOfSalaries()
	 */
