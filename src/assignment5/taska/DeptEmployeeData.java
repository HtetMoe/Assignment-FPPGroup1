...
public class DeptEmployeeData {
    ...
    public static void main(String[] args) {
        DeptEmployee[] employees = getDeptData();
        System.out.println(STR."Before sorting : \{Arrays.toString(employees)}");

        //sort
        Arrays.sort(employees, new NameComparator());
        System.out.println(STR."After sorting : \{Arrays.toString(employees)}");
    }
